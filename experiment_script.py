...
def show_info(txt):
# show a message
    msg = visual.TextStim(win, text=txt, pos = [0,0.2], height = 0.1)
...
show_info("Disclaimer: \nAll stories presented in this experiment are completely fictitious and was desgined for the puprose of testing a specific hypothesis. \nSo there is no reason to feel anxious about the information you read during the experiment.")
